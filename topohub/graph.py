...
def save_topo_graph_svg(g, filename=None, scale=None, background=None):
    ...
    with open(filename + '.svg', 'w') as f:
        ...
        f.write(f'<style>#topo path {{fill: none; stroke: grey; stroke-width: {stroke_width:.4f}px;}} #topo circle {{fill: lightblue; stroke: none; stroke-width: 1; vector-effect: non-scaling-stroke; r: {circle_radius:.4f}px;}} #topo text {{fill: black; stroke: none; font-size: {font_size:.4f}px; font-family: sans-serif; text-anchor:middle; transform: translateY(0.3em);}} #topo path.country {{fill: lightgrey; stroke: black; stroke-width: 1; vector-effect: non-scaling-stroke; visibility: visible;}} #topo path.selection {{fill: none; stroke: red; stroke-width: 1; vector-effect: non-scaling-stroke; visibility: visible;}} #topo path.utilization {{visibility: hidden;}}</style>\n')
