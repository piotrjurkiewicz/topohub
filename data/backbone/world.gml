graph [
  ...
  stats [
    ...
    min_link_len 0.14
    avg_link_len 276.32
    max_link_len 7698.64
    diameter_len 42016.14
    diameter_hops 113
    avg_sdp_num 1.03
    max_sdp_num 3
    avg_sdp_hops 24.84
  ...
  node [
    id 1172
    label "Metropolitan Government of Nashville-Davidson (balance)"
    type "City"
    lon -86.78
    lat 36.17
  ]
